...
makedocs(;
    modules = [StatsPostForecasts],
    authors = "Vitor Cantarella vcantarella@cantarellalabs.com",
    repo = "https://github.com/cantarella-labs/StatsPostForecasts.jl/blob/{commit}{path}#{line}",
    sitename = "StatsPostForecasts.jl",
    format = Documenter.HTML(;
        canonical = "https://cantarella-labs.github.io/StatsPostForecasts.jl",
    ),
    pages = list_pages(),
    plugins = [bib],
)

deploydocs(; repo = "github.com/cantarella-labs/StatsPostForecasts.jl")
